...
SELECT D.first_name, D.last_name,D.specialization,payment_status,hospital_branch,amount,
       SUM(CASE 
	          WHEN payment_status = 'Paid' THEN amount ELSE 0 END) AS 'Paid Total',
	   SUM(CASE
	          WHEN payment_status = 'Pending' THEN amount ELSE 0 END) AS 'Pending Total',
...
GROUP BY D.first_name, D.last_name,D.specialization,payment_status,hospital_branch,amount
